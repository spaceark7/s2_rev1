...
final TextTheme brandTextTheme = TextTheme(
  headline1: GoogleFonts.lobster(
    fontSize: 92, fontWeight: FontWeight.w400, letterSpacing: -0.5
  ),
  headline2: GoogleFonts.lobster(
    fontSize: 57, fontWeight: FontWeight.w400, letterSpacing: -0.5
  ),
  headline3: GoogleFonts.lobster(
    fontSize: 46  , fontWeight: FontWeight.w400, letterSpacing: -0.5
  ),
  headline4: GoogleFonts.lobster(
    fontSize: 32, fontWeight: FontWeight.w400, letterSpacing: -0.5
  ),
  headline5: GoogleFonts.lobster(
    fontSize: 23, fontWeight: FontWeight.w400, letterSpacing: -0.5
  ),
